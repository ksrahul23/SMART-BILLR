...
export default function LandingPage({ onOpen, onOpenHistory }) {
          ...
          {session ? (
            <div className="flex items-center gap-3">
              <button
                ...
                className="text-xs text-foreground/50 hover:text-foreground font-medium transition-colors uppercase tracking-[0.05em]"
              >
                History
              </button>
              <div
                className="h-9 w-9 border border-foreground/30 flex items-center justify-center bg-foreground/[0.03] overflow-hidden"
              ...
              <div className="text-[11px] font-bold text-foreground tracking-[0.05em] uppercase pointer-events-none">
                {(session.user.user_metadata?.full_name ||
            ...
            <a
              href="https://github.com/ksrahul23/SMART-BILLR"
              target="_blank"
